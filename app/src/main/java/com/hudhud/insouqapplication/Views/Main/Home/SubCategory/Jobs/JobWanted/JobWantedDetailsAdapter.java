...
public class JobWantedDetailsAdapter extends RecyclerView.Adapter<JobWantedDetailsAdapter.ViewHolder> {

    ArrayList<JobAd> jobAds;
    JobWantedDetailsFragment jobDetailsFragment;
    Context context;
    boolean fav = false;

    public JobWantedDetailsAdapter(ArrayList<JobAd> jobAds, JobWantedDetailsFragment jobDetailsFragment) {
        this.jobAds = jobAds;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.job_wanted_details_item, parent, false);
