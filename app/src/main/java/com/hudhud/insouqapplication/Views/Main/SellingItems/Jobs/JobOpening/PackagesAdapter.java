...
public class PackagesAdapter extends RecyclerView.Adapter<PackagesAdapter.ViewHolder> {
    ...
    PostJobOpeningAdFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter(PostJobOpeningAdFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
