...
public class Sell4Fragment extends Fragment {

    NavController navController;
    ImageView backToPrevious, home, profile, chat, sellItem, list;
    MainActivity mainActivity;
    MaterialButton continueBtn;
    Spinner specsSpinner, colorSpinner, doorsSpinner, warrantySpinner, transmissionSpinner, bodySpinner, fuelSpinner, cylinderSpinner;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sell4, container, false);
    }
...
//        continueBtn.setOnClickListener(view -> navController.navigate(Sell4FragmentDirections.actionSell4FragmentToSell5Fragment()));
