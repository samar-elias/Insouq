...
import com.hudhud.insouqapplication.Views.Main.SellingItems.Numbers.PostNumbersAdFragment;

import java.util.ArrayList;

public class PackagesAdapter2 extends RecyclerView.Adapter<PackagesAdapter2.ViewHolder> {

    PostServiceAdCarFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter2(PostServiceAdCarFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
