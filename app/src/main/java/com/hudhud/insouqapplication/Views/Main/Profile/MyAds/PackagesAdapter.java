...
import com.hudhud.insouqapplication.Views.Main.SellingItems.Business.PostBusinessAdFragment;

import java.util.ArrayList;

public class PackagesAdapter extends RecyclerView.Adapter<PackagesAdapter.ViewHolder> {

    MoreViewsFragment moreViewsFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter(MoreViewsFragment moreViewsFragment, ArrayList<PackageFS> packages, int selectedPosition) {
        this.moreViewsFragment = moreViewsFragment;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (selectedPosition==position){
            ...
            moreViewsFragment.freeCB.setChecked(false);
            moreViewsFragment.packageId = packageFS.getId();
        }else {
