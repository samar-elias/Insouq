...
public class PackagesAdapter extends RecyclerView.Adapter<PackagesAdapter.ViewHolder> {
    ...
    PostServiceAdFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter(PostServiceAdFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
