...
public class PackagesAdapter2 extends RecyclerView.Adapter<PackagesAdapter2.ViewHolder> {
    ...
    PostNumbersAdFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter2(PostNumbersAdFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
