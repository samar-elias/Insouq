...
import com.hudhud.insouqapplication.Views.Main.SellingItems.Motors.Parts.FullPartFragment;

import java.util.ArrayList;

public class PackagesAdapter extends RecyclerView.Adapter<PackagesAdapter.ViewHolder> {

    Sell3Fragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter(Sell3Fragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
