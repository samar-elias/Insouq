...
import com.hudhud.insouqapplication.Views.Main.SellingItems.Motors.UsedCars.Sell3Fragment;

import java.util.ArrayList;

public class PackagesAdapter extends RecyclerView.Adapter<PackagesAdapter.ViewHolder> {

    PostMobileNumberAdFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter(PostMobileNumberAdFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
