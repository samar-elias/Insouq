...
import com.hudhud.insouqapplication.Views.Main.SellingItems.Motors.Machinary.FullMachineryFragment;

import java.util.ArrayList;

public class PackagesAdapter extends RecyclerView.Adapter<PackagesAdapter.ViewHolder> {

    FullPartFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter(FullPartFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
