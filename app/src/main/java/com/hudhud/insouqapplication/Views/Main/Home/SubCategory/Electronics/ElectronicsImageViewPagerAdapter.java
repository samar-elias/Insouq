...
public class ElectronicsImageViewPagerAdapter extends PagerAdapter {
    ...
    public ElectronicsImageViewPagerAdapter(ArrayList<Picture> contents, MainActivity mainActivity, ElectronicsDetailsFragment motorDetailsFragment, boolean isBase) {
        this.contents = contents;
        this.mainActivity = mainActivity;
        this.electronicsDetailsFragment = motorDetailsFragment;
        this.isBase = isBase;
    }

    public ElectronicsImageViewPagerAdapter(MainActivity mainActivity) {
        this.mainActivity = mainActivity;
    ...
    public Object instantiateItem(@NonNull ViewGroup  container, int position) {
        ...
        image.setOnClickListener(view1 -> {
            if (isBase){
                electronicsDetailsFragment.initSlider(contents);
            }
        });
        return view;
    }
