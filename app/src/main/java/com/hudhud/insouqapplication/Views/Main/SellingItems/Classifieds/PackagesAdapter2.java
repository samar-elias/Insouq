...
public class PackagesAdapter2 extends RecyclerView.Adapter<PackagesAdapter2.ViewHolder> {
    ...
    PostClassifiedsGroup2AdFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter2(PostClassifiedsGroup2AdFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
