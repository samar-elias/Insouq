package com.hudhud.insouqapplication.Views.Main.Profile.SellingGuidlines;
...
public class SellingGuidlinesFragment extends Fragment {

    NavController navController;
    MainActivity mainActivity;
    ImageView home, profile, chat, sellItem, list, backToPrevious;

    public SellingGuidlinesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_selling_guidlines, container, false);
    }
