...
public class PackagesAdapter extends RecyclerView.Adapter<PackagesAdapter.ViewHolder> {
    ...
    PostClassifiedsGroup1AdFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter(PostClassifiedsGroup1AdFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
