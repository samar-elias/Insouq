...
import com.hudhud.insouqapplication.Views.Main.SellingItems.Electronics.PostElectronicsAdFragment;

import java.util.ArrayList;

public class PackagesAdapter extends RecyclerView.Adapter<PackagesAdapter.ViewHolder> {

    PostFullJobWantedAdFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter(PostFullJobWantedAdFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
