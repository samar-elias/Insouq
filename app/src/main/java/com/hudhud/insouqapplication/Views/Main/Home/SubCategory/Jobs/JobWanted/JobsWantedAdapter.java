...
public class JobsWantedAdapter extends RecyclerView.Adapter<JobsWantedAdapter.ViewHolder> {
    ...
    public JobsWantedAdapter(SubCategoryFragment subCategoryFragment, ArrayList<JobAd> jobAds) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View jobsView = inflater.inflate(R.layout.job_wanted_item_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.experience.setText(jobAd.getEnWorkExperience());
        if (jobAd.getOtherJobType().equals("null")){
            if (AppDefs.language.equals("ar")){
                holder.title.setText(jobAd.getArJobType());
            }else {
                holder.title.setText(jobAd.getEnJobType());
            }
        }else {
            holder.title.setText(jobAd.getOtherJobType());
        }
        ...
        holder.itemView.setOnClickListener(view -> subCategoryFragment.navigateToJobWantedDetails(position));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            title = itemView.findViewById(R.id.job_position);
