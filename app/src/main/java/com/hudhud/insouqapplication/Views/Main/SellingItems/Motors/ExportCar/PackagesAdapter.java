...
import com.hudhud.insouqapplication.Views.Main.SellingItems.Motors.Boats.FullBoatsFragment;

import java.util.ArrayList;

public class PackagesAdapter extends RecyclerView.Adapter<PackagesAdapter.ViewHolder> {

    FullExportCarFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter(FullExportCarFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
