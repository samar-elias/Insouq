...
import com.hudhud.insouqapplication.Views.Main.Home.SubCategory.Motors.Bike.Bike2Fragment;

import java.util.ArrayList;

public class UsagesAdapter extends RecyclerView.Adapter<UsagesAdapter.ViewHolder> {

    EmploymentTypeFragment employmentTypeFragment;
    ArrayList<Model> models;

    public UsagesAdapter(EmploymentTypeFragment employmentTypeFragment, ArrayList<Model> models) {
        this.employmentTypeFragment = employmentTypeFragment;
        this.models = models;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            employmentTypeFragment.navigateToSubCategories();
        });
    }
