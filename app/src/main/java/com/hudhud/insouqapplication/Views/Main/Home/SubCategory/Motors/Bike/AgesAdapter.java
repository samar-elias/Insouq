...
public class AgesAdapter extends RecyclerView.Adapter<AgesAdapter.ViewHolder> {
    ...
    Bike1Fragment bike1Fragment;
    ArrayList<Brand> brands;

    public AgesAdapter(Bike1Fragment bike1Fragment, ArrayList<Brand> brands) {
        this.bike1Fragment = bike1Fragment;
        this.brands = brands;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            if (brand.getId().equals("-1")){
                bike1Fragment.navigateToList();
            }else {
                bike1Fragment.navigateToModels(brand.getId());
            }
        });
    }
