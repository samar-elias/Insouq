...
public class NumberItemAdapter extends RecyclerView.Adapter<NumberItemAdapter.ViewHolder> {
    ...
    public NumberItemAdapter(MyFavouritesFragment subCategoryFragment, ArrayList<NumberAd> numberAds) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View numbersView = inflater.inflate(R.layout.numbers_item_layout, parent, false);
