...
import com.hudhud.insouqapplication.Views.Main.SellingItems.Motors.Bikes.FullBikeFragment;

import java.util.ArrayList;

public class PackagesAdapter extends RecyclerView.Adapter<PackagesAdapter.ViewHolder> {

    FullBoatsFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter(FullBoatsFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
