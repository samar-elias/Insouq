...
public class AgesAdapter extends RecyclerView.Adapter<AgesAdapter.ViewHolder> {
    ...
    CareerLevelFragment careerLevelFragment;
    ArrayList<Brand> brands;

    public AgesAdapter(CareerLevelFragment careerLevelFragment, ArrayList<Brand> brands) {
        this.careerLevelFragment = careerLevelFragment;
        this.brands = brands;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            if (brand.getId().equals("-1")){
                ...
                careerLevelFragment.navigateToList();
            }else {
                careerLevelFragment.navigateToModels(brand.getId());
            }
        });
    }
