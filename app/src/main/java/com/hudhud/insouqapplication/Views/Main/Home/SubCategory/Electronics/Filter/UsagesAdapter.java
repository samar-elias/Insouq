...
import com.hudhud.insouqapplication.Views.Main.Home.SubCategory.Services.Filter.ItemNameFragment;
...
public class UsagesAdapter extends RecyclerView.Adapter<UsagesAdapter.ViewHolder> {
    ...
    public UsagesAdapter(ModelFragment modelFragment, ArrayList<Model> models) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            modelFragment.navigateToSubCategories();
        });
    }
