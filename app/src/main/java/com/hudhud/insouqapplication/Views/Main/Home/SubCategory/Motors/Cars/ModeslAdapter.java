...
public class ModeslAdapter extends RecyclerView.Adapter<ModeslAdapter.ViewHolder> {

    ModelFragment modelFragment;
    ArrayList<Model> models;

    public ModeslAdapter(ModelFragment modelFragment, ArrayList<Model> models) {
