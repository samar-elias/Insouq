...
import com.hudhud.insouqapplication.Views.Main.Home.SubCategory.Motors.Cars.ModelFragment;
...
public class UsagesAdapter extends RecyclerView.Adapter<UsagesAdapter.ViewHolder> {
    ...
    public UsagesAdapter(Filter2Fragment filter2Fragment, ArrayList<Model> models) {
        this.filter2Fragment = filter2Fragment;
        this.models = models;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            filter2Fragment.navigateToSubCategories();
        });
    }
