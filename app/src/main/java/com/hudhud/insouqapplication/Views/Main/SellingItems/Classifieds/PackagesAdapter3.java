...
public class PackagesAdapter3 extends RecyclerView.Adapter<PackagesAdapter3.ViewHolder> {

    PostClassifiedsGroup3AdFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter3(PostClassifiedsGroup3AdFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
