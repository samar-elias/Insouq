...
public class NumberFragment extends Fragment {
    ...
    private void initViews(View view){
        ...
        if (getArguments() != null){
            brandId = NumberFragmentArgs.fromBundle(getArguments()).getBrandId();
            categoryId = NumberFragmentArgs.fromBundle(getArguments()).getCategoryId();
        }
    ...
    public void navigateToSubCategories(){
        navController.navigate(NumberFragmentDirections.actionNumberFragmentToSubCategoryFragment2("Numbers",0, categoryId));
    }
    ...
    private void getModels(){
        ...
        StringRequest modelsRequest = new StringRequest(Request.Method.GET, Urls.DropDowns_URL+"GetAllMobileNumberCodeByOperator?operatorName="+brandId, response -> {
...
//                    model.setId(modelObj.getString("id"));
                    model.setTitleAr(modelObj.getString("value"));
