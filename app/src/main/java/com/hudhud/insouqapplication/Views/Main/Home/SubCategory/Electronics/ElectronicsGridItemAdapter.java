...
public class ElectronicsGridItemAdapter extends RecyclerView.Adapter<ElectronicsGridItemAdapter.ViewHolder> {
    ...
    public ElectronicsGridItemAdapter(SubCategoryFragment subCategoryFragment, ArrayList<ElectronicAd> electronicAds, String categoryId) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View numbersView = inflater.inflate(R.layout.electronics_grid_item_layout, parent, false);
