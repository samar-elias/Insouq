...
public class MyClassifiedsAdsAdapter extends RecyclerView.Adapter<MyClassifiedsAdsAdapter.ViewHolder> {

    MyAdsFragment myAdsFragment;
    ArrayList<ElectronicAd> electronicAds;
    Context context;

    public MyClassifiedsAdsAdapter(MyAdsFragment myAdsFragment, ArrayList<ElectronicAd> electronicAds) {
    ...
    @NonNull
    @Override
    public MyClassifiedsAdsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyClassifiedsAdsAdapter.ViewHolder holder, int position) {
        ElectronicAd electronicAd = electronicAds.get(position);

        if (electronicAd.getStatus().equals("2")){
        ...
        holder.options.setOnClickListener(view -> myAdsFragment.showAdOptions("6", electronicAd.getId()));
        holder.getMoreViews.setOnClickListener(view -> myAdsFragment.navigateToMoreViews("6", electronicAd.getId()));
