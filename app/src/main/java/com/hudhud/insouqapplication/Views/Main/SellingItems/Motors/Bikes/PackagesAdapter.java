...
import com.hudhud.insouqapplication.Views.Main.SellingItems.Jobs.JobWanted.PostFullJobWantedAdFragment;

import java.util.ArrayList;

public class PackagesAdapter extends RecyclerView.Adapter<PackagesAdapter.ViewHolder> {

    FullBikeFragment businessAdFragment;
    ArrayList<PackageFS> packages;
    int selectedPosition;
    Context context;

    public PackagesAdapter(FullBikeFragment businessAdFragment, ArrayList<PackageFS> packages, int selectedPosition) {
